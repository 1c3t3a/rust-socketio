...
use super::callback::{Callback, DynAsyncAnyCallback, DynAsyncCallback};
use crate::{
...
mod test {
    ...
    use crate::{
        asynchronous::client::{builder::ClientBuilder, RawClient},
        error::Result,
        packet::{Packet, PacketId},
    ...
    async fn test_socketio_socket(socket: RawClient, nsp: String) -> Result<()> {
        // open packet
        let mut socket_stream = socket.as_stream();
